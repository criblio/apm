...
const BUILDERS: Array<{ id: string; call: () => string }> = [
  ...
  { id: 'incidentGrouper',               call: () => Q.incidentGrouper() },
  { id: 'incidentStateFold',             call: () => Q.incidentStateFold() },
  { id: 'incidentEvents (all)',          call: () => Q.incidentEvents() },
  { id: 'incidentEvents (scoped)',       call: () => Q.incidentEvents('inc:1787110200') },
  ...
  { id: 'metricRequestsExport',          call: () => Q.metricRequestsExport() },
  { id: 'metricDurationExport',          call: () => Q.metricDurationExport() },
  { id: 'metricEdgeCallsExport',         call: () => Q.metricEdgeCallsExport() },
  { id: 'metricEdgeDurationExport',      call: () => Q.metricEdgeDurationExport() },
  { id: 'metricMessagingExport',         call: () => Q.metricMessagingExport() },
  { id: 'metricMessagingDurationExport', call: () => Q.metricMessagingDurationExport() },
  { id: 'metricStatusClassExport',       call: () => Q.metricStatusClassExport() },
  { id: 'metricDurationExportSampled',   call: () => Q.metricDurationExport({ sampleRate: 0.25 }) },
  { id: 'metricLatencyPercentileExport',      call: () => Q.metricLatencyPercentileExport(95) },
  { id: 'metricLatencyPercentileExport op',   call: () => Q.metricLatencyPercentileExport(50, { byOperation: true }) },
  { id: 'metricEdgeLatencyP95Export',         call: () => Q.metricEdgeLatencyP95Export() },
  { id: 'metricMessagingLatencyP95Export',    call: () => Q.metricMessagingLatencyP95Export() },
  { id: 'backfillSpanCounts',            call: () => Q.backfillSpanCounts(300) },
